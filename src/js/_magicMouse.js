export function changeCursor() {
  const ref = document.querySelectorAll('a,input,button');
  ref.forEach(r => r.classList.add('magic-hover', 'magic-hover__square'));
  magicMouse();
}
function magicMouse(e) {
  ...
  var v = () => {
    r &&
      ...
      (r.style.height = a + 'px')),
      o &&
        (o.style.transform = 'matrix(1, 0, 0, 1, ' + l + ', ' + m + ') translate3d(-50%, -50%, 0)'),
